	...
	-->
  	...
  	<frameset rows="68,*" frameborder="yes" border="1" framespacing="1">
 		...
 		<frameset cols="240,*" frameborder="no" border="0" framespacing="1">
	   		<frame src="Navigation1.jsp" name="leftFrame" scrolling="No" noresize="noresize" id="leftFrame" title="leftFrame"></frame>

	   		<frame src="ElectricUpdate.jsp" name="mainFrame" noresize="noresize" id="mainFrame" title="mainFrame"></frame>
   	    </frameset> 
  	<frameset>
