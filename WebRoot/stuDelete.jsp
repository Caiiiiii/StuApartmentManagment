  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="checkOn">确认</button>
      </div>
    </div>
  </div>
</div>
	  ...
	  if(window.ActiveXObject){   //是IE浏览器  
	            ...
	            xmlhttp.onreadystatechange = function() {         
		  		 	if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
						...
						$("#table tbody").append('<tr><td></td><td></td><td></td><td></td><td></td><td><button class="btn btn-danger" id="stuDel" data-toggle="modal" data-target="#myModal" value="'+sd.stuBena[a].stuNo+'" onclick="btuDel(this);">删除</button></td></tr>');
